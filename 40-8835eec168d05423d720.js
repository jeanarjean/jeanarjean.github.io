/*! For license information please see 40-8835eec168d05423d720.js.LICENSE.txt */
                ...
                function (e) {
                    ...
                    function p(e) {
                        if (e && void 0 !== e)
                            switch (e) {
                                case u.b['3024-NIGHT']:
                                    return i.e(41).then(i.bind(null, 'fHu9'))
                                case u.b['A11Y-DARK']:
                                    return i.e(42).then(i.bind(null, 'vz3n'))
                                case u.b['BASE16-DARK']:
                                    return i.e(43).then(i.bind(null, 'o6JQ'))
                                case u.b['BASE16-LIGHT']:
                                    return i.e(44).then(i.bind(null, 'Js3n'))
                                case u.b.BLACKBOARD:
                                    return i.e(45).then(i.bind(null, 'xMsC'))
                                case u.b.COBALT:
                                    return i.e(46).then(i.bind(null, 'yRNi'))
                                case u.b.DUOTONE:
                                    return i.e(48).then(i.bind(null, 'BIBC'))
                                case u.b.HOPSCOTCH:
                                    return i.e(49).then(i.bind(null, 'EVXs'))
                                case u.b.LUCARIO:
                                    return i.e(50).then(i.bind(null, 'X2gj'))
                                case u.b.MATERIAL:
                                    return i.e(51).then(i.bind(null, 'DTb2'))
                                case u.b.MONOKAI:
                                    return i.e(52).then(i.bind(null, 'OesK'))
                                case u.b['NIGHT-OWL']:
                                    return i.e(53).then(i.bind(null, 'QyS/'))
                                case u.b.NORD:
                                    return i.e(54).then(i.bind(null, 'CQ5s'))
                                case u.b['OCEANIC-NEXT']:
                                    return i.e(55).then(i.bind(null, 'BGkj'))
                                case u.b['ONE-DARK']:
                                    return i.e(56).then(i.bind(null, 'P3/g'))
                                case u.b['ONE-LIGHT']:
                                    return i.e(57).then(i.bind(null, 'nYQy'))
                                case u.b.PANDA:
                                    return i.e(58).then(i.bind(null, '54lw'))
                                case u.b.PARAISO:
                                    return i.e(59).then(i.bind(null, 'nBrO'))
                                case u.b.SETI:
                                    return i.e(60).then(i.bind(null, 'lHhr'))
                                case u.b['SHADES-OF-PURPLE']:
                                    return i.e(61).then(i.bind(null, '8QXN'))
                                case u.b['SOLARIZED-DARK']:
                                    return i.e(62).then(i.bind(null, 'gnLW'))
                                case u.b['SOLARIZED-LIGHT']:
                                    return i.e(63).then(i.bind(null, 'ebc7'))
                                case u.b.SYNTHWAVE:
                                    return i.e(64).then(i.bind(null, 'O1eY'))
                                case u.b.TWILIGHT:
                                    return i.e(65).then(i.bind(null, 'oNnQ'))
                                case u.b.VERMINAL:
                                    return i.e(66).then(i.bind(null, 'f8K0'))
                                case u.b.VSCODE:
                                    return i.e(67).then(i.bind(null, 'eOFy'))
                                case u.b.YETI:
                                    return i.e(68).then(i.bind(null, 'zsXk'))
                                case u.b.ZENBURN:
                                    return i.e(69).then(i.bind(null, 'bxwY'))
                                default:
                                    return i.e(47).then(i.bind(null, 'CBc6'))
                            }
                    }
                    var m = function (e) {
                            var t = e.style
...
//# sourceMappingURL=40-8835eec168d05423d720.js.map
